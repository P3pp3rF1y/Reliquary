		...
		public static class ItemSettings {
			...
			public static class RodOfLyssaSettings {
				...
				private void initBlockedEntityTypes() {
					...
					for (var entityName : entityBlockList.get()) {
						BuiltInRegistries.ENTITY_TYPE.getOptional(ResourceLocation.parse(entityName)).ifPresent(entityType -> blockedEntities.add(entityType));
					}
				}
			}
			...
			public static class SojournerStaffSettings {
				...
				private Set<Item> getTorchItemsFromRegistryNames() {
					return torches.get().stream().map(torchRegistryName -> BuiltInRegistries.ITEM.getValue(ResourceLocation.parse(torchRegistryName)))
