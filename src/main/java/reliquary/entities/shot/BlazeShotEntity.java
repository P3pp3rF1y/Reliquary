...
public class BlazeShotEntity extends ShotEntityBase {
	...
	protected void onHit(HitResult result) {
		if (result.getType() == HitResult.Type.ENTITY) {
			...
			if (((Player) getOwner()).mayUseItemAt(fireSpawnPos, blockResult.getDirection(), new ItemStack(Items.FLINT_AND_STEEL)) && level.isEmptyBlock(fireSpawnPos)) {
				level.setBlockAndUpdate(fireSpawnPos, Blocks.FIRE.defaultBlockState());
			}
		}
	}
