...
public class AccessoryMobCharmBeltRenderer implements AccessoryRenderer {
	...
	public static final Material ON_BODY_TEXTURE = MAPPER.apply(Reliquary.getRL("equipment/humanoid/mob_charm_belt"));
	...
	public <S extends LivingEntityRenderState> void render(AccessoryRenderState accessoryState, S entityState, EntityModel<S> model, PoseStack poseStack, SubmitNodeCollector collector) {
		...
		collector.submitModelPart(beltModel.body, poseStack, ON_BODY_TEXTURE.renderType(RenderType::entityCutoutNoCull), entityState.lightCoords, OverlayTexture.NO_OVERLAY, atlasManager.get(ON_BODY_TEXTURE));
	}
}
