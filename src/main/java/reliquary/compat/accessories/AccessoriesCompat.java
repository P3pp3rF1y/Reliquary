...
public class AccessoriesCompat {
	...
	private void onSetup(FMLCommonSetupEvent event) {
		AccessoryRegistry.register(ModItems.MOB_CHARM_BELT.get(), NO_QUICK_EQUIP_ACCESSORY);
		AccessoryRegistry.register(ModItems.FORTUNE_COIN.get(), NO_QUICK_EQUIP_ACCESSORY);
		AccessoryRegistry.register(ModItems.HERO_MEDALLION.get(), NO_QUICK_EQUIP_ACCESSORY);
	}
