...
public class ModItems {
	...
	private static final DeferredRegister<net.minecraft.world.item.crafting.RecipeType<?>> RECIPE_TYPES = DeferredRegister.create(BuiltInRegistries.RECIPE_TYPE, Reliquary.MOD_ID);
	...
	public static final Supplier<ItemBase> GRIP_ASSEMBLY = ITEMS.registerItem("grip_assembly", properties -> new ItemBase(properties.stacksTo(4), Config.COMMON.disable.disableHandgun));
	public static final Supplier<ItemBase> BARREL_ASSEMBLY = ITEMS.registerItem("barrel_assembly", properties -> new ItemBase(properties.stacksTo(4), Config.COMMON.disable.disableHandgun));
	public static final Supplier<ItemBase> HAMMER_ASSEMBLY = ITEMS.registerItem("hammer_assembly", properties -> new ItemBase(properties.stacksTo(4), Config.COMMON.disable.disableHandgun));
	...
	public static final Supplier<ItemBase> EMPTY_POTION_VIAL = ITEMS.registerItem("empty_potion_vial", properties -> new ItemBase(Config.COMMON.disable.disablePotions, properties));
	...
	public static final Supplier<MagazineItem> NEUTRAL_MAGAZINE = ITEMS.registerItem("magazines/neutral_magazine", properties ->
			new MagazineItem(true, Integer.parseInt(Colors.NEUTRAL_SHOT_COLOR, 16), properties));
	public static final Supplier<MagazineItem> EXORCISM_MAGAZINE = ITEMS.registerItem("magazines/exorcism_magazine", properties ->
			new MagazineItem(false, Integer.parseInt(Colors.EXORCISM_SHOT_COLOR, 16), properties));
	public static final Supplier<MagazineItem> BLAZE_MAGAZINE = ITEMS.registerItem("magazines/blaze_magazine", properties ->
			new MagazineItem(false, Integer.parseInt(Colors.BLAZE_SHOT_COLOR, 16), properties));
	public static final Supplier<MagazineItem> ENDER_MAGAZINE = ITEMS.registerItem("magazines/ender_magazine", properties ->
			new MagazineItem(false, Integer.parseInt(Colors.ENDER_SHOT_COLOR, 16), properties));
	public static final Supplier<MagazineItem> CONCUSSIVE_MAGAZINE = ITEMS.registerItem("magazines/concussive_magazine", properties ->
			new MagazineItem(false, Integer.parseInt(Colors.CONCUSSIVE_SHOT_COLOR, 16), properties));
	public static final Supplier<MagazineItem> BUSTER_MAGAZINE = ITEMS.registerItem("magazines/buster_magazine", properties ->
			new MagazineItem(false, Integer.parseInt(Colors.BUSTER_SHOT_COLOR, 16), properties));
	public static final Supplier<MagazineItem> SEEKER_MAGAZINE = ITEMS.registerItem("magazines/seeker_magazine", properties ->
			new MagazineItem(false, Integer.parseInt(Colors.SEEKER_SHOT_COLOR, 16), properties));
	public static final Supplier<MagazineItem> SAND_MAGAZINE = ITEMS.registerItem("magazines/sand_magazine", properties ->
			new MagazineItem(false, Integer.parseInt(Colors.SAND_SHOT_COLOR, 16), properties));
	public static final Supplier<MagazineItem> STORM_MAGAZINE = ITEMS.registerItem("magazines/storm_magazine", properties ->
			new MagazineItem(false, Integer.parseInt(Colors.STORM_SHOT_COLOR, 16), properties));
	public static final Supplier<BulletItem> EMPTY_BULLET = ITEMS.registerItem("bullets/empty_bullet", properties ->
			new BulletItem(false, false, Integer.parseInt(Colors.DARKEST, 16), properties));
	public static final Supplier<BulletItem> NEUTRAL_BULLET = ITEMS.registerItem("bullets/neutral_bullet", properties ->
			new BulletItem(false, true, Integer.parseInt(Colors.NEUTRAL_SHOT_COLOR, 16), properties));
	public static final Supplier<BulletItem> EXORCISM_BULLET = ITEMS.registerItem("bullets/exorcism_bullet", properties ->
			new BulletItem(true, false, Integer.parseInt(Colors.EXORCISM_SHOT_COLOR, 16), properties));
	public static final Supplier<BulletItem> BLAZE_BULLET = ITEMS.registerItem("bullets/blaze_bullet", properties ->
			new BulletItem(true, false, Integer.parseInt(Colors.BLAZE_SHOT_COLOR, 16), properties));
	public static final Supplier<BulletItem> ENDER_BULLET = ITEMS.registerItem("bullets/ender_bullet", properties ->
			new BulletItem(true, false, Integer.parseInt(Colors.ENDER_SHOT_COLOR, 16), properties));
	public static final Supplier<BulletItem> CONCUSSIVE_BULLET = ITEMS.registerItem("bullets/concussive_bullet", properties ->
			new BulletItem(true, false, Integer.parseInt(Colors.CONCUSSIVE_SHOT_COLOR, 16), properties));
	public static final Supplier<BulletItem> BUSTER_BULLET = ITEMS.registerItem("bullets/buster_bullet", properties ->
			new BulletItem(true, false, Integer.parseInt(Colors.BUSTER_SHOT_COLOR, 16), properties));
	public static final Supplier<BulletItem> SEEKER_BULLET = ITEMS.registerItem("bullets/seeker_bullet", properties ->
			new BulletItem(true, false, Integer.parseInt(Colors.SEEKER_SHOT_COLOR, 16), properties));
	public static final Supplier<BulletItem> SAND_BULLET = ITEMS.registerItem("bullets/sand_bullet", properties ->
			new BulletItem(true, false, Integer.parseInt(Colors.SAND_SHOT_COLOR, 16), properties));
	public static final Supplier<BulletItem> STORM_BULLET = ITEMS.registerItem("bullets/storm_bullet", properties ->
			new BulletItem(true, false, Integer.parseInt(Colors.STORM_SHOT_COLOR, 16), properties));
	...
	public static final Supplier<ItemBase> GLOWING_BREAD = ITEMS.registerItem("glowing_bread", properties ->
			new ItemBase(properties.rarity(Rarity.RARE).food(
					new FoodProperties.Builder().nutrition(20).saturationModifier(1F).build(),
					Consumables.defaultFood().consumeSeconds(0.8F).build()
			)));
	public static final Supplier<Item> XP_BUCKET = ITEMS.registerItem("xp_bucket", properties -> new BucketItem(ModFluids.XP_STILL.get(), properties.stacksTo(1)));
	...
	public static final Supplier<net.minecraft.world.item.crafting.RecipeType<InfernalTearValueRecipe>> INFERNAL_TEAR_VALUE_TYPE = RECIPE_TYPES.register("infernal_tear_value", () -> net.minecraft.world.item.crafting.RecipeType.simple(Reliquary.getIdentifier("infernal_tear_value")));
	...
	public static final Supplier<RecipeSerializer<InfernalTearValueRecipe>> INFERNAL_TEAR_VALUE_SERIALIZER = RECIPE_SERIALIZERS.register("infernal_tear_value", () -> new RecipeSerializer<>(InfernalTearValueRecipe.MAP_CODEC, InfernalTearValueRecipe.STREAM_CODEC));
