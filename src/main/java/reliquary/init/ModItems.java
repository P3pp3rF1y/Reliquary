...
public class ModItems {
	...
	public static final Supplier<RecipeType<InfernalTearValueRecipe>> INFERNAL_TEAR_VALUE_TYPE = RECIPE_TYPES.register("infernal_tear_value", () -> RecipeType.simple(Reliquary.getRL("infernal_tear_value")));
	...
	public static final Supplier<RecipeSerializer<InfernalTearValueRecipe>> INFERNAL_TEAR_VALUE_SERIALIZER = RECIPE_SERIALIZERS.register("infernal_tear_value", InfernalTearValueRecipeSerializer::new);
