...
public class ModItems {
	...
	public static final Supplier<net.minecraft.world.item.crafting.RecipeType<InfernalTearValueRecipe>> INFERNAL_TEAR_VALUE_TYPE = RECIPE_TYPES
			.register("infernal_tear_value", () -> net.minecraft.world.item.crafting.RecipeType.simple(Reliquary.getRL("infernal_tear_value")));
	public static final Supplier<RecipeSerializer<? extends ShapedRecipe>> MOB_CHARM_RECIPE_SERIALIZER = RECIPE_SERIALIZERS.register("mob_charm",
			MobCharmRecipe.Serializer::new);
	public static final Supplier<RecipeSerializer<? extends CraftingRecipe>> FRAGMENT_TO_SPAWN_EGG_SERIALIZER = RECIPE_SERIALIZERS
			.register("fragment_to_spawn_egg", FragmentToSpawnEggRecipe.Serializer::new);
	...
	public static final Supplier<CustomRecipe.Serializer<MobCharmRepairRecipe>> MOB_CHARM_REPAIR_SERIALIZER = RECIPE_SERIALIZERS.register("mob_charm_repair",
			() -> new CustomRecipe.Serializer<>(MobCharmRepairRecipe::new));
	public static final Supplier<RecipeSerializer<? extends CraftingRecipe>> ALKAHESTRY_CHARGING_SERIALIZER = RECIPE_SERIALIZERS.register("alkahestry_charging",
			AlkahestryChargingRecipe.Serializer::new);
	public static final Supplier<RecipeSerializer<? extends CraftingRecipe>> ALKAHESTRY_CRAFTING_SERIALIZER = RECIPE_SERIALIZERS.register("alkahestry_crafting",
			AlkahestryCraftingRecipe.Serializer::new);
	public static final Supplier<RecipeSerializer<? extends CraftingRecipe>> ALKAHESTRY_DRAIN_SERIALIZER = RECIPE_SERIALIZERS.register("alkahestry_drain",
			AlkahestryDrainRecipe.Serializer::new);
	public static final Supplier<RecipeSerializer<? extends CraftingRecipe>> POTION_EFFECTS_SERIALIZER = RECIPE_SERIALIZERS.register("potion_effects",
