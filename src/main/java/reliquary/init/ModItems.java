...
public class ModItems {
	...
	public static final Supplier<RecipeType<InfernalTearValueRecipe>> INFERNAL_TEAR_VALUE_TYPE = RECIPE_TYPES.register("infernal_tear_value",
			() -> RecipeType.simple(Reliquary.getRL("infernal_tear_value")));
	...
	public static final Supplier<RecipeSerializer<InfernalTearValueRecipe>> INFERNAL_TEAR_VALUE_SERIALIZER = RECIPE_SERIALIZERS.register("infernal_tear_value",
			InfernalTearValueRecipeSerializer::new);
	...
	private static final DeferredRegister<AttachmentType<?>> ATTACHMENT_TYPES = DeferredRegister.create(NeoForgeRegistries.Keys.ATTACHMENT_TYPES,
			Reliquary.MOD_ID);
	public static final ItemCapability<HarvestRodCache, Void> HARVEST_ROD_CACHE_CAPABILITY = ItemCapability.createVoid(Reliquary.getRL("harvest_rod_cache"),
