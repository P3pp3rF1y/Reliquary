...
public class ModEntities {
	...
	public static final Supplier<EntityType<AphroditePotion>> APHRODITE_POTION = ENTITY_TYPES.register("aphrodite_potion",
			() -> getDefaultSizeEntityType(AphroditePotion::new));
	public static final Supplier<EntityType<FertilePotion>> FERTILE_POTION = ENTITY_TYPES.register("fertile_potion",
			() -> getDefaultSizeEntityType(FertilePotion::new));
	public static final Supplier<EntityType<ThrownPotion>> THROWN_POTION = ENTITY_TYPES.register("thrown_potion",
	...
	public static final Supplier<EntityType<ConcussiveShot>> CONCUSSIVE_SHOT = ENTITY_TYPES.register("concussive_shot",
			() -> getShotEntityType(ConcussiveShot::new));
	...
	public static final Supplier<EntityType<EnderStaffProjectile>> ENDER_STAFF_PROJECTILE = ENTITY_TYPES.register("ender_staff_projectile",
			() -> getEntityType(EnderStaffProjectile::new, 0.25F, 0.25F, 256));
	public static final Supplier<EntityType<GlowingWater>> GLOWING_WATER = ENTITY_TYPES.register("glowing_water",
			() -> getDefaultSizeEntityType(GlowingWater::new));
	public static final Supplier<EntityType<HolyHandGrenade>> HOLY_HAND_GRENADE = ENTITY_TYPES.register("holy_hand_grenade",
			() -> getDefaultSizeEntityType(HolyHandGrenade::new));
	public static final Supplier<EntityType<KrakenSlime>> KRAKEN_SLIME = ENTITY_TYPES.register("kraken_slime",
			() -> getDefaultSizeEntityType(KrakenSlime::new));
	...
	public static final Supplier<EntityType<TippedArrow>> TIPPED_ARROW = ENTITY_TYPES.register("tipped_arrow",
			() -> getDefaultSizeEntityType(TippedArrow::new));
	public static final Supplier<EntityType<SpecialSnowball>> SPECIAL_SNOWBALL = ENTITY_TYPES.register("special_snowball",
			() -> getEntityType(SpecialSnowball::new, 0.01F, 0.01F));
