...
public class PassivePedestalRenderer implements BlockEntityRenderer<PassivePedestalBlockEntity, PassivePedestalRenderer.PedestalRenderState> {
	...
	@Override
	public void extractRenderState(PassivePedestalBlockEntity blockEntity, PedestalRenderState renderState, float partialTick, Vec3 cameraPos, ModelFeatureRenderer.@Nullable CrumblingOverlay crumblingOverlay) {
