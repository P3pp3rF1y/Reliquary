...
public class EntityLootInjectSubProvider implements LootTableSubProvider {
	...
	public static final ResourceKey<LootTable> BAT = EntityTypes.BAT.getDefaultLootTable().map(EntityLootInjectSubProvider::createInjectLootTableRegistryKey)
			.orElseThrow();
	public static final ResourceKey<LootTable> BLAZE = EntityTypes.BLAZE.getDefaultLootTable()
			.map(EntityLootInjectSubProvider::createInjectLootTableRegistryKey).orElseThrow();
	public static final ResourceKey<LootTable> CAVE_SPIDER = EntityTypes.CAVE_SPIDER.getDefaultLootTable()
			.map(EntityLootInjectSubProvider::createInjectLootTableRegistryKey).orElseThrow();
	public static final ResourceKey<LootTable> CREEPER = EntityTypes.CREEPER.getDefaultLootTable()
			.map(EntityLootInjectSubProvider::createInjectLootTableRegistryKey).orElseThrow();
	public static final ResourceKey<LootTable> ENDERMAN = EntityTypes.ENDERMAN.getDefaultLootTable()
			.map(EntityLootInjectSubProvider::createInjectLootTableRegistryKey).orElseThrow();
	public static final ResourceKey<LootTable> GHAST = EntityTypes.GHAST.getDefaultLootTable()
			.map(EntityLootInjectSubProvider::createInjectLootTableRegistryKey).orElseThrow();
	public static final ResourceKey<LootTable> GUARDIAN = EntityTypes.GUARDIAN.getDefaultLootTable()
			.map(EntityLootInjectSubProvider::createInjectLootTableRegistryKey).orElseThrow();
	public static final ResourceKey<LootTable> HUSK = EntityTypes.HUSK.getDefaultLootTable().map(EntityLootInjectSubProvider::createInjectLootTableRegistryKey)
			.orElseThrow();
	public static final ResourceKey<LootTable> MAGMA_CUBE = EntityTypes.MAGMA_CUBE.getDefaultLootTable()
			.map(EntityLootInjectSubProvider::createInjectLootTableRegistryKey).orElseThrow();
	public static final ResourceKey<LootTable> SKELETON = EntityTypes.SKELETON.getDefaultLootTable()
			.map(EntityLootInjectSubProvider::createInjectLootTableRegistryKey).orElseThrow();
	public static final ResourceKey<LootTable> SNOW_GOLEM = EntityTypes.SNOW_GOLEM.getDefaultLootTable()
			.map(EntityLootInjectSubProvider::createInjectLootTableRegistryKey).orElseThrow();
	public static final ResourceKey<LootTable> SLIME = EntityTypes.SLIME.getDefaultLootTable()
			.map(EntityLootInjectSubProvider::createInjectLootTableRegistryKey).orElseThrow();
	public static final ResourceKey<LootTable> SPIDER = EntityTypes.SPIDER.getDefaultLootTable()
			.map(EntityLootInjectSubProvider::createInjectLootTableRegistryKey).orElseThrow();
	public static final ResourceKey<LootTable> SQUID = EntityTypes.SQUID.getDefaultLootTable()
			.map(EntityLootInjectSubProvider::createInjectLootTableRegistryKey).orElseThrow();
	public static final ResourceKey<LootTable> STRAY = EntityTypes.STRAY.getDefaultLootTable()
			.map(EntityLootInjectSubProvider::createInjectLootTableRegistryKey).orElseThrow();
	public static final ResourceKey<LootTable> WITCH = EntityTypes.WITCH.getDefaultLootTable()
			.map(EntityLootInjectSubProvider::createInjectLootTableRegistryKey).orElseThrow();
	public static final ResourceKey<LootTable> WITHER_SKELETON = EntityTypes.WITHER_SKELETON.getDefaultLootTable()
			.map(EntityLootInjectSubProvider::createInjectLootTableRegistryKey).orElseThrow();
	public static final ResourceKey<LootTable> ZOMBIE = EntityTypes.ZOMBIE.getDefaultLootTable()
			.map(EntityLootInjectSubProvider::createInjectLootTableRegistryKey).orElseThrow();
	public static final ResourceKey<LootTable> ZOMBIE_VILLAGER = EntityTypes.ZOMBIE_VILLAGER.getDefaultLootTable()
			.map(EntityLootInjectSubProvider::createInjectLootTableRegistryKey).orElseThrow();
