...
public class ReliquaryLootModifierProvider extends GlobalLootModifierProvider {
	...
	protected void start() {
		ChestLootInjectSubProvider.LOOT_INJECTS.forEach((vanillaLootTable, injectLootTable) -> add(vanillaLootTable.identifier().getPath(),
				InjectLootModifier.chest(injectLootTable, vanillaLootTable)));

		EntityLootInjectSubProvider.LOOT_INJECTS.forEach((vanillaLootTable, injectLootTable) -> add(vanillaLootTable.identifier().getPath(),
				InjectLootModifier.entity(injectLootTable, vanillaLootTable)));
	}
