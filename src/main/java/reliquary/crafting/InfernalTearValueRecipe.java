...
public class InfernalTearValueRecipe implements net.minecraft.world.item.crafting.CraftingRecipe {
	...
	public static class Serializer implements RecipeSerializer<InfernalTearValueRecipe> {
		private static final MapCodec<InfernalTearValueRecipe> CODEC = RecordCodecBuilder
				.mapCodec(
						instance -> instance
								.group(Ingredient.CODEC_NONEMPTY.fieldOf("ingredient").forGetter(InfernalTearValueRecipe::getIngredient),
		...
		private static final StreamCodec<RegistryFriendlyByteBuf, InfernalTearValueRecipe> STREAM_CODEC = StreamCodec.composite(
				ByteBufCodecs.fromCodecWithRegistries(Ingredient.CODEC_NONEMPTY), InfernalTearValueRecipe::getIngredient, ByteBufCodecs.INT,
