...
public class ClientEventHandler {
	...
	private static void registerMovingStorageRenderStateModifiers(RegisterRenderStateModifiersEvent event) {
		...
		event.registerEntityModifier((Class<? extends EntityRenderer<? extends Avatar, ? extends AvatarRenderState>>) (Class<?>) AvatarRenderer.class,
				RENDER_STATE_MODIFIER);
	}
	...
	private static void initHUDComponents() {
		hudComponents.add(Pair.of(new ChargeableItemInfoPane(ModItems.ALKAHESTRY_TOME.get(), Config.CLIENT.hudPositions.alkahestryTome.get(),
				new ItemStack(Items.REDSTONE), AlkahestryTomeItem::getCharge), Config.CLIENT.hudPositions.alkahestryTome.get()));

		hudComponents.add(Pair.of(new ChargeableItemInfoPane(ModItems.DESTRUCTION_CATALYST.get(), Config.CLIENT.hudPositions.destructionCatalyst.get(),
				new ItemStack(Items.GUNPOWDER), DestructionCatalystItem::getGunpowder), Config.CLIENT.hudPositions.destructionCatalyst.get()));

		hudComponents.add(Pair.of(new ChargeableItemInfoPane(ModItems.MIDAS_TOUCHSTONE.get(), Config.CLIENT.hudPositions.midasTouchstone.get(),
		...
		hudComponents.add(Pair.of(new ChargeableItemInfoPane(ModItems.ICE_MAGUS_ROD.get(), Config.CLIENT.hudPositions.iceMagusRod.get(),
				new ItemStack(Items.SNOWBALL), IceMagusRodItem::getSnowballs), Config.CLIENT.hudPositions.iceMagusRod.get()));

		hudComponents.add(Pair.of(new ChargeableItemInfoPane(ModItems.GLACIAL_STAFF.get(), Config.CLIENT.hudPositions.glacialStaff.get(),
				new ItemStack(Items.SNOWBALL), GlacialStaffItem::getSnowballs), Config.CLIENT.hudPositions.glacialStaff.get()));

		hudComponents.add(Pair.of(new ChargeableItemInfoPane(ModItems.ENDER_STAFF.get(), Config.CLIENT.hudPositions.enderStaff.get(),
		...
		hudComponents.add(Pair.of(new ChargeableItemInfoPane(ModItems.RENDING_GALE.get(), Config.CLIENT.hudPositions.rendingGale.get(),
		...
		hudComponents
				.add(Pair.of(new ChargeableItemInfoPane(ModItems.VOID_TEAR.get(), Config.CLIENT.hudPositions.voidTear.get(),
		...
		hudComponents.add(Pair.of(new ChargeableItemInfoPane(ModItems.SOJOURNER_STAFF.get(), Config.CLIENT.hudPositions.sojournerStaff.get(),
		...
		hudComponents
				.add(Pair.of(Box.createVertical(Box.Alignment.RIGHT, new HandgunPane(InteractionHand.OFF_HAND), new HandgunPane(InteractionHand.MAIN_HAND)),
	...
	private static void registerFluidModels(RegisterFluidModelsEvent event) {
		event.register(new FluidModel.Unbaked(
				...
				new net.minecraft.client.resources.model.sprite.Material(Identifier.fromNamespaceAndPath(Reliquary.MOD_ID, "block/xp_flowing")), null, null),
