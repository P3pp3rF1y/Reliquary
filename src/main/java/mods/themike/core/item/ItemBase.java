...
/**
 * ItemBase, a helper class for items. Handles language names, language tooltips, and icon registering.
 * 
 * @author TheMike
 */
public class ItemBase extends Item {
	...
	/**
	 * Just a call to formatTooltip(). If you are overriding this function, call formatTooltip() directly and DO NOT call super.addInformation().
	 */
    @Override
    ...
    /**
     * Used to format tooltips. Grabs tooltip from language registry with the entry 'item.unlocalizedName.tooltip'. Has support for Handlebars-style templating, and line breaking using '\n'.
     * @param toFormat An ImmutableMap that has all the regex keys and values. Regex strings are handled on the tooltip by including '{{regexKey}}' with your regex key, of course. 
