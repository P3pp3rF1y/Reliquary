...
public class XRRecipes {
    ...
    public static void init() {
        ...
        if (isEasyMode(Names.alkahestry_tome))
            addRecipe(true, new ItemStack(getItem(Names.alkahestry_tome), 1, 0), Items.book, getItem(Names.witch_hat), moltenCore(), witherSkull());
        else
            addRecipe(true, new ItemStack(getItem(Names.alkahestry_tome), 1, 0), moltenCore(), getItem(Names.witch_hat), stormEye(), creeperGland(), Items.book, slimePearl(), spiderFangs(), witherSkull(), enderHeart());

        //glowstone altar
        if (isEasyMode(Names.altar))
            addRecipe(true, new ItemStack(ContentHandler.getBlock(Names.altar_idle), 1), Blocks.obsidian, Blocks.redstone_lamp, enderHeart(), creeperGland());
        else
            addRecipe(false, new ItemStack(ContentHandler.getBlock(Names.altar_idle), 1), "dnd", "olo", "dgd", 'd', Items.glowstone_dust, 'n', enderHeart(), 'o', Blocks.obsidian, 'l', Blocks.redstone_lamp, 'g', creeperGland());

        //lilypad
        addRecipe(true, new ItemStack(ContentHandler.getBlock(Names.lilypad), 1), fertileEssence(), fertileEssence(), fertileEssence(), Blocks.waterlily);

        //wraith node
        addRecipe(true, new ItemStack(ContentHandler.getBlock(Names.wraith_node), 1), enderHeart(), Items.emerald);

        //interdiction torch
        if (isEasyMode(Names.interdiction_torch))
            addRecipe(false, new ItemStack(getItem(Names.interdiction_torch), 4, 0), "bm", "nr", 'b', batWing(), 'm', moltenCore(), 'n', enderHeart(), 'r', Items.blaze_rod);
        else
            addRecipe(false, new ItemStack(getItem(Names.interdiction_torch), 4, 0), " n ", "mdm", "bwb", 'n', enderHeart(), 'm', moltenCore(), 'd', Items.diamond, 'b', Items.blaze_rod, 'w', batWing());
        ...
        if (isEasyMode(Names.fertile_essence))
            addRecipe(true, fertileEssence(), fertilizer(), fertilizer(), fertilizer(), Items.wheat_seeds);
        else
            addRecipe(true, fertileEssence(), fertilizer(), fertilizer(), fertilizer(), fertilizer(), fertilizer(), fertilizer(), fertilizer(), fertilizer(), Items.wheat_seeds);
        ...
        // exorcist
        addRecipe(true, bullet(8, 2), bullet(1, 1), bullet(1, 1), bullet(1, 1), bullet(1, 1), bullet(1, 1), bullet(1, 1), bullet(1, 1), bullet(1, 1), zombieHeart());
        // blaze
        addRecipe(true, bullet(8, 3), Items.blaze_powder, Items.blaze_rod, Items.gold_nugget, Items.gold_nugget);
        // ender
        addRecipe(true, bullet(8, 4),  bullet(1, 7), bullet(1, 7), bullet(1, 7), bullet(1, 7), bullet(1, 7), bullet(1, 7), bullet(1, 7), bullet(1, 7), enderHeart());
        // concussive
        addRecipe(true, bullet(8, 5), Items.slime_ball, Items.gold_nugget, Items.gold_nugget, Items.gunpowder);
        // buster
        addRecipe(true, bullet(8, 6), bullet(1, 5), bullet(1, 5), bullet(1, 5), bullet(1, 5), bullet(1, 5), bullet(1, 5), bullet(1, 5), bullet(1, 5), creeperGland());
        ...
        if (isEasyMode(Names.seeker_shot))
            ...
            addRecipe(true, bullet(4, 7), lapis(), slimePearl(), Items.gold_nugget, Items.gunpowder);
        // sand
        addRecipe(true, bullet(8, 8), Blocks.sandstone, Items.gold_nugget, Items.gold_nugget, Items.gunpowder);
        // storm
        addRecipe(true, bullet(8, 9), stormEye(), Items.gold_nugget, Items.gold_nugget, Items.gunpowder);
        // frozen shot TODO
        // venom shot TODO
        // fertile shot TODO
        // rage shot TODO
        ...
        addRecipe(false, gunPart(1, 1), "iii", "eme", "iii", 'i', Items.iron_ingot, 'e', enderHeart(), 'm', Items.magma_cream);
        addRecipe(false, gunPart(1, 2), "iib", "rmi", "iii", 'i', Items.iron_ingot, 'b', Blocks.stone_button, 'r', Items.blaze_rod, 'm', moltenCore());

        // handgun
        addRecipe(false, new ItemStack(getItem(Names.handgun), 1, 0), "bim", "isi", "igi", 'i', Items.iron_ingot, 'b', gunPart(1, 1), 'm', gunPart(1, 2), 'g', gunPart(1, 0), 's', slimePearl());

		// fortune coin
        if (isEasyMode(Names.fortune_coin))
            addRecipe(true, new ItemStack(getItem(Names.fortune_coin), 1), enderHeart(), Items.gold_nugget, slimePearl(), batWing());
        else
            addRecipe(false, new ItemStack(getItem(Names.fortune_coin), 1), "ege", "gng", "ege", 'e', Items.ender_eye, 'g', Items.gold_ingot, 'n', enderHeart());

        // cross of mercy
        addRecipe(false, new ItemStack(getItem(Names.mercy_cross), 1), "wgr", "glg", "sgz", 'w', witherRib(), 'g', Items.gold_ingot, 'r', ribBone(), 'l', Items.leather, 's', new ItemStack(Items.skull, 1, 1), 'z', zombieHeart());

        // holy hand grenade
        addRecipe(true, new ItemStack(getItem(Names.holy_hand_grenade), 4), getItem(Names.glowing_water), Items.gold_nugget, Blocks.tnt, creeperGland());

        // sojourner's staff
        if (isEasyMode(Names.sojourner_staff))
            addRecipe(true, new ItemStack(getItem(Names.sojourner_staff), 1), moltenCore(), Items.gold_ingot, Items.blaze_rod, emptyVoidTear());
        else
            addRecipe(false, new ItemStack(getItem(Names.sojourner_staff), 1), "gcm", "itc", "big", 'g', Items.gold_nugget, 'c', Items.magma_cream, 'm', moltenCore(), 'i', Items.gold_ingot, 't', getItem(Names.infernal_tear), 'b', Items.blaze_rod);

        // lantern of paranoia
        if (isEasyMode(Names.lantern_of_paranoia))
            addRecipe(false, new ItemStack(getItem(Names.lantern_of_paranoia), 1), "isi", "gmg", " i ", 'i', Items.iron_ingot, 's', slimePearl(),  'g', Blocks.glass, 'm', moltenCore());
        else
            addRecipe(false, new ItemStack(getItem(Names.lantern_of_paranoia), 1), "imi", "gtg", "ili", 'i', Items.iron_ingot, 'm', moltenCore(), 'g', Blocks.glass, 't', ContentHandler.getBlock(Names.interdiction_torch), 'l', creeperGland());

        // midas touchstone
        addRecipe(true, new ItemStack(getItem(Names.midas_touchstone), 1, 0), Blocks.anvil, Blocks.gold_block, Blocks.gold_block, moltenCore(), moltenCore(), moltenCore(), creeperGland(), creeperGland(), emptyVoidTear());

        // emperor's chalice
        if (isEasyMode(Names.emperor_chalice))
            addRecipe(true, new ItemStack(getItem(Names.emperor_chalice), 1, 0), Items.emerald, Items.gold_ingot, Items.bucket, emptyVoidTear());
        else
            addRecipe(false, new ItemStack(getItem(Names.emperor_chalice), 1, 0), "ses", "ivi", "lbl", 's', slimePearl(), 'e', Items.emerald, 'i', Items.gold_ingot, 'v', emptyVoidTear(),  'l', lapis(), 'b', Items.bucket);

        // infernal chalice
        if (isEasyMode(Names.infernal_chalice))
            addRecipe(true, new ItemStack(getItem(Names.infernal_chalice), 1), getItem(Names.infernal_claws), getItem(Names.emperor_chalice), getItem(Names.infernal_tear), moltenCore());
        else
            addRecipe(false, new ItemStack(getItem(Names.infernal_chalice), 1), "imi", "wcw", "mtm", 'i', getItem(Names.infernal_claws), 'm', moltenCore(), 'w', witherRib(), 'c', getItem(Names.emperor_chalice), 't', getItem(Names.infernal_tear));

        // salamander's eye
        if (isEasyMode(Names.salamander_eye))
            addRecipe(true, new ItemStack(getItem(Names.salamander_eye), 1), Items.ender_eye, moltenCore(), frozenCore(), enderHeart());
        else
            addRecipe(false, new ItemStack(getItem(Names.salamander_eye), 1), "fnm", "geg", "mnf", 'f', frozenCore(), 'n', enderHeart(), 'm', moltenCore(), 'g', Items.ghast_tear, 'e', Items.ender_eye);

        // ice rod
        if (isEasyMode(Names.ice_magus_rod))
            addRecipe(false, new ItemStack(getItem(Names.ice_magus_rod), 1, 0), " df", " vd", "i  ", 'd', Items.diamond, 'f', frozenCore(), 'i', Items.iron_ingot, 'v', emptyVoidTear());
        else
            addRecipe(false, new ItemStack(getItem(Names.ice_magus_rod), 1, 0), "fdf", "ptd", "ipf", 'f', frozenCore(), 'd', Items.diamond, 'p', Blocks.packed_ice, 't', emptyVoidTear(), 'i', Items.iron_ingot);

        //glacial staff
        if (isEasyMode(Names.glacial_staff))
            addRecipe(true, new ItemStack(getItem(Names.glacial_staff), 1, 0), getItem(Names.ice_magus_rod), emptyVoidTear(), frozenCore(), getItem(Names.shears_of_winter));
        else
            addRecipe(false, new ItemStack(getItem(Names.glacial_staff), 1, 0), "fds", "fvd", "iff", 'f', frozenCore(), 'd', Items.diamond, 's', getItem(Names.shears_of_winter), 'v', emptyVoidTear(), 'i', getItem(Names.ice_magus_rod));

        // ender staff
        if (isEasyMode(Names.ender_staff))
            addRecipe(false, new ItemStack(getItem(Names.ender_staff), 1, 0), " be", "nvb", "sn ", 'v', getItem(Names.void_tear), 'e', Items.ender_eye, 's', Items.stick, 'n', enderHeart(), 'b', batWing());
        else
            addRecipe(false, new ItemStack(getItem(Names.ender_staff), 1, 0), "nbe", "nvb", "rnn", 'n', enderHeart(), 'b', batWing(), 'e', Items.ender_eye, 'v', emptyVoidTear(), 'r', Items.blaze_rod);

        // rending gale
        if (isEasyMode(Names.rending_gale))
            addRecipe(false, new ItemStack(getItem(Names.rending_gale), 1, 0), " be", "gvb", "sg ", 'b', batWing(), 'e', stormEye(), 'g', Items.gold_ingot, 'v', emptyVoidTear(), 's', Items.stick);
        else
            addRecipe(false, new ItemStack(getItem(Names.rending_gale), 1, 0), "ebe", "fvb", "rfe", 'e', stormEye(), 'b', batWing(), 'f', getItem(Names.angelic_feather), 'v', emptyVoidTear(), 'r', Items.blaze_rod);

        // harvest rod
        addRecipe(false, new ItemStack(getItem(Names.harvest_rod), 1, 0), " rf", "vtr", "sv ", 'r', roseBush(), 'f', fertileEssence(), 'v', Blocks.vine, 't', emptyVoidTear(), 's', Items.stick );

        // pyromancer staff
        if (isEasyMode(Names.pyromancer_staff))
            addRecipe(true, new ItemStack(getItem(Names.pyromancer_staff), 1, 0), getItem(Names.infernal_claws), Items.blaze_rod, getItem(Names.infernal_tear), getItem(Names.salamander_eye));
        else
            addRecipe(false, new ItemStack(getItem(Names.pyromancer_staff), 1, 0), "mcs", "mic", "rmm", 'm', moltenCore(), 'c', getItem(Names.infernal_claws), 's', getItem(Names.salamander_eye), 'i', getItem(Names.infernal_tear), 'r', Items.blaze_rod);

        // serpent staff
        if (isEasyMode(Names.serpent_staff))
            addRecipe(false, new ItemStack(getItem(Names.serpent_staff), 1), " ce", " kc", "s  ", 'c', spiderFangs(), 'e', Items.ender_eye, 'k', shellFragment(), 'b', Items.stick);
        else
            addRecipe(false, new ItemStack(getItem(Names.serpent_staff), 1), "coe", "pko", "bpc", 'c', spiderFangs(), 'o', Blocks.obsidian, 'e', Items.ender_eye, 'p', slimePearl(), 'k', shellFragment(), 'b', Items.blaze_rod);

        // rod of lyssa
        if (isEasyMode(Names.rod_of_lyssa))
            addRecipe(true, new ItemStack(getItem(Names.rod_of_lyssa), 1, 0), infernalClaw(), batWing(), enderHeart(), Items.fishing_rod);
        else
            addRecipe(false, new ItemStack(getItem(Names.rod_of_lyssa), 1, 0), " br", "nms", "r i", 'b', batWing(), 'r', Items.blaze_rod, 'n', enderHeart(), 'm', moltenCore(), 's', Items.string, 'i', infernalClaw());

        // shears of winter
        addRecipe(true, new ItemStack(getItem(Names.shears_of_winter), 1, 0), frozenCore(), Items.shears, Items.diamond, Items.diamond);

        // magicbane
        if (isEasyMode(Names.magicbane))
            addRecipe(false, new ItemStack(getItem(Names.magicbane), 1, 0), "ng", "in", 'g', Items.gold_ingot, 'i', Items.iron_ingot, 'n', enderHeart());
        else
            addRecipe(false, new ItemStack(getItem(Names.magicbane), 1, 0), "een", "nge", "ine", 'e', Items.ender_eye, 'n', enderHeart(), 'g', Items.gold_ingot, 'i', Items.iron_ingot);

        // witherless rose
        addRecipe(false, new ItemStack(getItem(Names.witherless_rose), 1), "fnf", "nrn", "fnf", 'f', fertileEssence(), 'n', Items.nether_star, 'r', roseBush() );

        // crimson cloth
        addRecipe(true, ingredient(Reference.CLOTH_INGREDIENT_META), new ItemStack(Blocks.wool, 1, Reference.RED_WOOL_META), new ItemStack(Blocks.wool, 1, Reference.BLACK_WOOL_META), enderHeart(), enderHeart());
        ...
        if (isEasyMode(Names.void_tear))
            addRecipe(true, emptyVoidTear(), Items.ghast_tear, enderHeart(), slimePearl(), lapis());
        else
            addRecipe(false, emptyVoidTear(), "lel", "pgp", "lnl", 'l', lapis(), 'e', Items.ender_pearl, 'p', slimePearl(), 'g', Items.ghast_tear, 'n', enderHeart());

        // infernal tear
        if (isEasyMode(Names.infernal_tear))
            addRecipe(true, new ItemStack(getItem(Names.infernal_tear), 1, 0), emptyVoidTear(), getItem(Names.witch_hat), moltenCore(), infernalClaw());
        else
            addRecipe(false, new ItemStack(getItem(Names.infernal_tear), 1, 0), "php", "mtm", "pcp", 'p', Items.blaze_powder, 'h', getItem(Names.witch_hat), 'm', moltenCore(), 't', emptyVoidTear(), 'c', infernalClaw());
        ...
        // infernal claw
        addRecipe(true, infernalClaw(), Items.leather, moltenCore(), ribBone(), slimePearl());

        // infernal claws
        if (isEasyMode(Names.infernal_claws))
            addRecipe(true, new ItemStack(getItem(Names.infernal_claws), 1), infernalClaw(), infernalClaw(), infernalClaw(), slimePearl());
        else
            addRecipe(false, new ItemStack(getItem(Names.infernal_claws), 1), "ccc", "cpc", "mlm", 'c', infernalClaw(), 'p', slimePearl(), 'm', moltenCore(), 'l', Items.leather);

        // squid beak, wither rib & rib bone to bonemeal
        addRecipe(true, new ItemStack(Items.dye, 2, Reference.WHITE_DYE_META), squidBeak());
        addRecipe(true, new ItemStack(Items.dye, 6, Reference.WHITE_DYE_META), ribBone());
        addRecipe(true, new ItemStack(Items.dye, 8, Reference.WHITE_DYE_META), witherRib());

        // kraken shell fragment
        addRecipe(true, shellFragment(), squidBeak(), squidBeak(), squidBeak(), slimePearl());

        // kraken shell
        if (isEasyMode(Names.kraken_shell))
            addRecipe(true, new ItemStack(getItem(Names.kraken_shell), 1, 0), shellFragment(), shellFragment(), shellFragment(), enderHeart());
        else
            addRecipe(false, new ItemStack(getItem(Names.kraken_shell), 1, 0), "nfn", "epe", "fnf", 'n', enderHeart(), 'f', shellFragment(), 'e', Items.ender_eye, 'p', slimePearl());
        ...
        if (isEasyMode(Names.hero_medallion))
            addRecipe(true, new ItemStack(getItem(Names.hero_medallion), 1), enderHeart(), new ItemStack(getItem(Names.fortune_coin), 1, -1), getItem(Names.witch_hat), getItem(Names.infernal_tear));
        else
            addRecipe(false, new ItemStack(getItem(Names.hero_medallion), 1), "nie", "iti", "fin", 'n', enderHeart(), 'i', Items.iron_ingot, 'e', Items.ender_eye, 't', getItem(Names.infernal_tear), 'f', new ItemStack(getItem(Names.fortune_coin), 1, -1));

        // destruction catalyst
        if (isEasyMode(Names.destruction_catalyst))
            addRecipe(true, new ItemStack(getItem(Names.destruction_catalyst), 1, 0), Items.flint_and_steel, moltenCore(), creeperGland(), getItem(Names.infernal_tear));
        else
            addRecipe(false, new ItemStack(getItem(Names.destruction_catalyst), 1, 0), "tmc", "gim", "fgt", 't', Blocks.tnt, 'm', moltenCore(), 'c', creeperGland(), 'g', Items.gold_ingot, 'i', getItem(Names.infernal_tear), 'f', Items.flint_and_steel);

        // nian zhu heart pearls
        addRecipe(false, heartPearl(Reference.ZOMBIE_ZHU_META), "ppp", "sts", "ppp", 'p', zombieHeart(), 's', Items.rotten_flesh, 't', Items.bone);
        addRecipe(false, heartPearl(Reference.SKELETON_ZHU_META), "ppp", "sts", "ppp", 'p', ribBone(), 's', Items.bone, 't', Items.flint);
        addRecipe(false, heartPearl(Reference.WITHER_SKELETON_ZHU_META), "ppp", "sts", "ppp", 'p', witherRib(), 's', Items.bone, 't', witherSkull());
        addRecipe(false, heartPearl(Reference.CREEPER_ZHU_META), "ppp", "sts", "ppp", 'p', creeperGland(), 's', Items.gunpowder, 't', Items.bone);
