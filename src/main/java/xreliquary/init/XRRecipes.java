...
public class XRRecipes {
    ...
    public static ItemStack gunPart(int amount, int meta) { return new ItemStack(ModItems.gunPart, amount, meta); }
    public static ItemStack magazine(int amount, int meta) { return new ItemStack(ModItems.magazine, amount, meta); }
    public static ItemStack bullet(int amount, int meta) { return new ItemStack(ModItems.bullet, amount, meta); }
    public static ItemStack ingredient(int amount, int m) { return new ItemStack(ModItems.mobIngredient, amount, m); }
    ...
    public static ItemStack heartPearl(int meta) { return new ItemStack(ModItems.heartPearl, 1, meta); }

    public static ItemStack nianZhu(int meta) { return new ItemStack(ModItems.heartZhu, 1, meta); }
