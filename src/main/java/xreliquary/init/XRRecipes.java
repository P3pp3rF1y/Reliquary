...
public class XRRecipes {
    ...
    public static ItemStack gunPart(int i, int m) {
        return new ItemStack(ContentHandler.getItem(Names.GUNPART_NAME), i, m);
    }
    ...
    public static ItemStack magazine(int i, int m) {
        return new ItemStack(ContentHandler.getItem(Names.MAGAZINE_NAME), i, m);
    }
    ...
    public static ItemStack bullet(int i, int m) {
        return new ItemStack(ContentHandler.getItem(Names.BULLET_NAME), i, m);
    }
    ...
    public static ItemStack potion(int i, int m) {
        return new ItemStack(ContentHandler.getItem(Names.CONDENSED_POTION_NAME), i, m);
    }

    public static void init() {

        GameRegistry.addRecipe(new ItemStack(ContentHandler.getBlock(Names.ALTAR_IDLE_NAME), 1), "olo", "lel", "olo", 'o', Blocks.obsidian, 'l', Blocks.redstone_lamp, 'e', Items.emerald);
        GameRegistry.addRecipe(new ItemStack(ContentHandler.getBlock(Names.LILYPAD_NAME), 1), "www", "wlw", "www", 'w', XRRecipes.potion(Reference.FERTILIZER_META), 'l', Blocks.waterlily);
        GameRegistry.addRecipe(new ItemStack(ContentHandler.getBlock(Names.WRAITHNODE_NAME), 1), "vv", "vv", 'v', ContentHandler.getItem(Names.EMPTY_VOID_TEAR_NAME));

        // GameRegistry.addShapelessRecipe(new ItemStack(ContentHandler.getItem(Names.BREAD_NAME), 3), new Object[]{Items.bread, Items.bread, Items.bread, ContentHandler.getItem(Names.GLOWING_WATER_NAME)});
        // bullets...
        ...
        // exorcist
        GameRegistry.addRecipe(bullet(8, 2), new Object[] { "bbb", "bhb", "bbb", 'b', bullet(1, 1), 'h', ContentHandler.getItem(Names.GLOWING_WATER_NAME) });
        // blaze
        ...
        // coin
        GameRegistry.addRecipe(new ItemStack(ContentHandler.getItem(Names.FORTUNE_COIN_NAME), 1), new Object[] { "ege", "ghg", "ege", 'e', Items.ender_eye, 'g', Items.gold_ingot, 'h', ContentHandler.getItem(Names.GLOWING_WATER_NAME) });

        // cross
        GameRegistry.addRecipe(new ItemStack(ContentHandler.getItem(Names.CROSS_NAME), 1), new Object[] { "wgw", "glg", "wgw", 'w', ContentHandler.getItem(Names.GLOWING_WATER_NAME), 'g', Items.gold_ingot, 'l', Items.leather });

        // grenade
        GameRegistry.addRecipe(new ItemStack(ContentHandler.getItem(Names.GRENADE_NAME), 4), new Object[] { "wgw", "gtg", "wgw", 'w', ContentHandler.getItem(Names.GLOWING_WATER_NAME), 'g', Items.gold_nugget, 't', Blocks.tnt });
        // torch
        GameRegistry.addRecipe(new ItemStack(ContentHandler.getItem(Names.TORCH_NAME), 1), new Object[] { "cgc", "gbg", "wgw", 'w', ContentHandler.getItem(Names.GLOWING_WATER_NAME), 'g', Items.gold_ingot, 'b', Items.blaze_rod, 'c', Items.magma_cream });
        ...
        // handgun
        GameRegistry.addRecipe(new ItemStack(ContentHandler.getItem(Names.HANDGUN_NAME), 1, 0), new Object[] { "bim", "isi", "igi", 'i', Items.iron_ingot, 'b', gunPart(1, 1), 'm', gunPart(1, 2), 'g', gunPart(1, 0), 's', Items.slime_ball });

        // tome
        ItemStack tombStack = new ItemStack(ContentHandler.getItem(Names.TOME_NAME), 1, 0);
        ...
        // touchstone
        GameRegistry.addRecipe(new ItemStack(ContentHandler.getItem(Names.TOUCHSTONE_NAME), 1, 0), new Object[] { "bbb", "rtr", "ggg", 'b', Blocks.glowstone, 'r', Items.blaze_rod, 'g', Items.gold_ingot, 't', Items.ghast_tear });

        // chalice
        GameRegistry.addRecipe(new ItemStack(ContentHandler.getItem(Names.CHALICE_NAME), 1, 0), new Object[] { "gtg", "ege", "tgt", 't', Items.ghast_tear, 'e', Items.emerald, 'g', Items.gold_ingot });

        // salamander's eye
        GameRegistry.addRecipe(new ItemStack(ContentHandler.getItem(Names.SALAMANDER_EYE_NAME), 1, 0), new Object[] { "bcb", "tet", "bcb", 'b', Items.blaze_rod, 'c', Items.magma_cream, 't', Items.ghast_tear, 'e', Items.ender_eye });

        // wraith's eye upgrade
        GameRegistry.addRecipe(new ItemStack(ContentHandler.getItem(Names.WRAITH_EYE_NAME), 1, 0), new Object[] { "eee", "bsb", "eee", 'e', ContentHandler.getItem(Names.EMPTY_VOID_TEAR_NAME), 's', ContentHandler.getItem(Names.SALAMANDER_EYE_NAME), 'b', Blocks.emerald_block });

        // ice rod
        GameRegistry.addRecipe(new ItemStack(ContentHandler.getItem(Names.ICE_ROD_NAME), 1, 0), new Object[] { "dtd", "tit", "tit", 'd', Items.diamond, 't', Items.ghast_tear, 'i', Items.iron_ingot });

        // magicbane
        GameRegistry.addRecipe(new ItemStack(ContentHandler.getItem(Names.MAGICBANE_NAME), 1, 0), new Object[] { "eee", "ege", "iee", 'e', Items.ender_eye, 'g', Items.gold_ingot, 'i', Items.iron_ingot });

        // rose
        GameRegistry.addRecipe(new ItemStack(ContentHandler.getItem(Names.WITHERLESS_ROSE_NAME), 1, 0), new Object[] { "hnh", "nrn", "hnh", 'h', ContentHandler.getItem(Names.GLOWING_WATER_NAME), 'n', Items.nether_star, 'r', Blocks.red_flower });

        // cloak
        GameRegistry.addRecipe(new ItemStack(ContentHandler.getItem(Names.DISTORTION_CLOAK_NAME), 1, 0), new Object[] { "eee", "ewe", "eee", 'e', Items.ender_eye, 'w', new ItemStack(Blocks.wool, 1, 11) });

        // void tear
        GameRegistry.addRecipe(new ItemStack(ContentHandler.getItem(Names.EMPTY_VOID_TEAR_NAME), 1, 0), new Object[] { "et", "te", 'e', Items.ender_eye, 't', Items.ghast_tear });

        // TODO possibly give satchels a damage bar, so these recipes will have
        // to change.

        // void satchel
        GameRegistry.addRecipe(new ItemStack(ContentHandler.getItem(Names.VOID_SATCHEL_NAME), 1, 0), new Object[] { "lsl", "ltl", "lll", 'l', Items.leather, 's', Items.string, 't', ContentHandler.getItem(Names.VOID_TEAR_NAME) }); // upgrade
        // it!
        GameRegistry.addShapelessRecipe(new ItemStack(ContentHandler.getItem(Names.VOID_SATCHEL_NAME), 1, 0), new Object[] { ContentHandler.getItem(Names.EMPTY_VOID_TEAR_NAME), ContentHandler.getItem(Names.EMPTY_VOID_TEAR_NAME), ContentHandler.getItem(Names.EMPTY_VOID_TEAR_NAME), ContentHandler.getItem(Names.VOID_SATCHEL_NAME) });

        // destruction catalyst
        GameRegistry.addRecipe(new ItemStack(ContentHandler.getItem(Names.DESTRUCTION_CATALYST_NAME), 1, 0), new Object[] { "rrr", "rtr", "rrf", 'f', Items.flint, 't', new ItemStack(ContentHandler.getItem(Names.TOUCHSTONE_NAME), 1, -1), 'r', Items.blaze_rod });
        ...
        // glowing water
        GameRegistry.addShapelessRecipe(new ItemStack(ContentHandler.getItem(Names.GLOWING_WATER_NAME), 1), new Object[] { potion(Reference.SPLASH_META), Items.glowstone_dust, Items.glowstone_dust, Items.glowstone_dust });
