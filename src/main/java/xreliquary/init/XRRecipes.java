...
/*
	...
	public static void init() {
		...
		// cross of mercy
		addRecipe(false, new ItemStack(ModItems.mercyCross, 1), "wgr", "glg", "sgz", 'w', WITHER_RIB, 'g', Items.GOLD_INGOT, 'r', RIB_BONE, 'l', Items.LEATHER, 's', new ItemStack(Items.SKULL, 1, 1), 'z', ZOMBIE_HEART);
		...
		// witherless rose
		addRecipe(false, new ItemStack(ModItems.witherlessRose, 1), "fnf", "nrn", "fnf", 'f', FERTILE_ESSENCE, 'n', Items.NETHER_STAR, 'r', ROSE_BUSH);

		// crimson cloth
		addRecipe(true, ingredient(1, Reference.CLOTH_INGREDIENT_META), new ItemStack(Blocks.WOOL, 1, Reference.RED_WOOL_META), new ItemStack(Blocks.WOOL, 1, Reference.BLACK_WOOL_META), NEBULOUS_HEART, NEBULOUS_HEART);
		...
		// mob charm fragments
		addRecipe(false, charmFragment(Reference.MOB_CHARM.ZOMBIE_META), "ppp", "sts", "ppp", 'p', ZOMBIE_HEART, 's', Items.ROTTEN_FLESH, 't', Items.BONE);
		addRecipe(false, charmFragment(Reference.MOB_CHARM.SKELETON_META), "ppp", "sts", "ppp", 'p', RIB_BONE, 's', Items.BONE, 't', Items.FLINT);
		addRecipe(false, charmFragment(Reference.MOB_CHARM.WITHER_SKELETON_META), "ppp", "sts", "ppp", 'p', WITHER_RIB, 's', Items.BONE, 't', WITHER_SKULL);
		addRecipe(false, charmFragment(Reference.MOB_CHARM.CREEPER_META), "ppp", "sts", "ppp", 'p', CREEPER_GLAND, 's', Items.GUNPOWDER, 't', Items.BONE);
		addRecipe(false, charmFragment(Reference.MOB_CHARM.WITCH_META), "ppp", "sts", "ppp", 'p', ModItems.witchHat, 's', Items.GLASS_BOTTLE, 't', Items.SPIDER_EYE);
		addRecipe(false, charmFragment(Reference.MOB_CHARM.ZOMBIE_PIGMAN_META), "ppp", "sts", "ppp", 'p', ZOMBIE_HEART, 's', Items.ROTTEN_FLESH, 't', Items.GOLDEN_SWORD);
		addRecipe(false, charmFragment(Reference.MOB_CHARM.CAVE_SPIDER_META), "ppp", "sts", "ppp", 'p', CHELICERAE, 's', Items.STRING, 't', PotionUtils.addPotionToItemStack(new ItemStack(Items.POTIONITEM), PotionTypes.POISON));
		addRecipe(false, charmFragment(Reference.MOB_CHARM.SPIDER_META), "ppp", "sts", "ppp", 'p', CHELICERAE, 's', Items.STRING, 't', Items.SPIDER_EYE);
		addRecipe(false, charmFragment(Reference.MOB_CHARM.ENDERMAN_META), "ppp", "sts", "ppp", 'p', NEBULOUS_HEART, 's', Items.ENDER_PEARL, 't', NEBULOUS_HEART);
		addRecipe(false, charmFragment(Reference.MOB_CHARM.BLAZE_META), "ppp", "sts", "ppp", 'p', MOLTEN_CORE, 's', Items.BLAZE_ROD, 't', Items.BLAZE_POWDER);
		addRecipe(false, charmFragment(Reference.MOB_CHARM.GHAST_META), "ppp", "sts", "ppp", 'p', Items.GHAST_TEAR, 's', Items.GUNPOWDER, 't', CREEPER_GLAND);
		addRecipe(false, charmFragment(Reference.MOB_CHARM.MAGMA_CUBE_META), "ppp", "sss", "ppp", 'p', MOLTEN_CORE, 's', Items.MAGMA_CREAM);
		addRecipe(false, charmFragment(Reference.MOB_CHARM.SLIME_META), "ppp", "sss", "ppp", 'p', SLIME_PEARL, 's', Items.SLIME_BALL);
		addRecipe(false, charmFragment(Reference.MOB_CHARM.GUARDIAN_META), "ppp", "sts", "ppp", 'p', GUARDIAN_SPIKE, 's', Items.PRISMARINE_SHARD, 't', Items.FISH);
 ...
 potions and splash potions
		...
		// glowing water
		addRecipe(false, new ItemStack(ModItems.glowingWater, 5), "gbg", "gdg", "ngp", 'g', Blocks.GLASS_PANE, 'b', Items.WATER_BUCKET, 'd', Items.GLOWSTONE_DUST, 'p', Items.GUNPOWDER, 'n', Items.NETHER_WART);

		// angelheart vial
		addRecipe(false, new ItemStack(ModItems.angelheartVial, 5), "gbg", "gcg", "fgf", 'g', Blocks.GLASS_PANE, 'b', Items.MILK_BUCKET, 'c', INFERNAL_CLAW, 'f', FERTILE_ESSENCE);

		// attraction
		addRecipe(false, new ItemStack(ModItems.attractionPotion, 5), "gbg", "gfg", "rgc", 'g', Blocks.GLASS_PANE, 'b', Items.WATER_BUCKET, 'f', FERTILE_ESSENCE, 'r', new ItemStack(Items.DYE, 1, Reference.RED_DYE_META), 'c', new ItemStack(Items.DYE, 1, Reference.BROWN_DYE_META));

		// fertility
		addRecipe(false, new ItemStack(ModItems.fertilePotion, 5), "gbg", "gfg", "cgy", 'g', Blocks.GLASS_PANE, 'b', Items.WATER_BUCKET, 'f', FERTILE_ESSENCE, 'c', new ItemStack(Items.DYE, 1, Reference.GREEN_DYE_META), 'y', new ItemStack(Items.DYE, 1, Reference.YELLOW_DYE_META));

		//pedestal
		for(int i = 0; i < 16; i++) {
			addRecipe(false, new ItemStack(ModBlocks.pedestal, 1, i), "d d", " p ", "d d", 'd', Items.DIAMOND, 'p', new ItemStack(ModBlocks.pedestalPassive, 1, i));
		}
		//passive pedestal
		for(int i = 0; i < 16; i++) {
			addRecipe(false, new ItemStack(ModBlocks.pedestalPassive, 1, i), " c ", "gqg", "sss", 'c', new ItemStack(Blocks.CARPET, 1, i), 'g', Items.GOLD_NUGGET, 'q', Blocks.QUARTZ_BLOCK, 's', new ItemStack(Blocks.STONE_SLAB, 1, 7));
		}
	...
	private static void addMobCharmRecipe(byte type) {
		...
		addRecipe(false, mobCharm, "flf", "fsf", "f f", 'f', fragment, 'l', Items.LEATHER, 's', Items.STRING);
	}

	private static void addMobDropCraftingRecipes() {
		addRecipe(false, RIB_BONE, "iii", "ibi", "iii", 'b', Items.BONE, 'i', Items.IRON_INGOT);
		addRecipe(false, ingredient(4, Reference.WITHER_INGREDIENT_META), "d d", " s ", "d d", 'd', Items.DIAMOND, 's', new ItemStack(Items.SKULL, 1, 1));
		addRecipe(false, CHELICERAE, "ggg", "gsg", "ggg", 's', Items.STRING, 'g', Items.GOLD_INGOT);
		addRecipe(false, CREEPER_GLAND, "ggg", "gpg", "ggg", 'p', Items.GUNPOWDER, 'g', Items.GOLD_INGOT);
		addRecipe(false, SLIME_PEARL, "iii", "isi", "iii", 's', Items.SLIME_BALL, 'i', Items.IRON_INGOT);
		addRecipe(false, BAT_WING, "ggg", "gfg", "ggg", 'f', Items.FEATHER, 'g', Items.GOLD_INGOT);
		addRecipe(false, ZOMBIE_HEART, "iii", "ifi", "iii", 'f', Items.ROTTEN_FLESH, 'i', Items.IRON_INGOT);
		addRecipe(false, MOLTEN_CORE, "ggg", "gmg", "ggg", 'm', Items.MAGMA_CREAM, 'g', Items.GOLD_INGOT);
		addRecipe(false, STORM_EYE, "ggg", "gcg", "ggg", 'c', CREEPER_GLAND, 'g', Items.GOLD_INGOT);
		addRecipe(false, FROZEN_CORE, "gpg", "gsg", "gsg", 'p', Blocks.PUMPKIN, 's', Blocks.SNOW, 'g', Items.GOLD_INGOT);
		addRecipe(false, NEBULOUS_HEART, "ggg", "geg", "ggg", 'e', Items.ENDER_PEARL, 'g', Items.GOLD_INGOT);
		addRecipe(false, SQUID_BEAK, "ggg", "gig", "ggg", 'i', Items.DYE, 'g', Items.GOLD_INGOT);
		addRecipe(false, GUARDIAN_SPIKE, "ggg", "gpg", "ggg", 'p', Items.PRISMARINE_SHARD, 'g', Items.GOLD_INGOT);
	}

	private static void addMobDropUncraftingRecipes() {
		addRecipe(true, new ItemStack(Items.BONE, 5), RIB_BONE);
		addRecipe(true, new ItemStack(Items.SKULL, 1, 1), WITHER_RIB, WITHER_RIB, WITHER_RIB, new ItemStack(Items.SKULL));
		addRecipe(true, new ItemStack(Items.ENDER_PEARL, 3), NEBULOUS_HEART);
		addRecipe(true, new ItemStack(Items.DYE, 6), SQUID_BEAK);
		addRecipe(true, new ItemStack(Items.STRING, 6), CHELICERAE);
		addRecipe(true, new ItemStack(Items.SPIDER_EYE, 2), CHELICERAE, CHELICERAE);
		addRecipe(true, new ItemStack(Items.GUNPOWDER, 6), CREEPER_GLAND);
		addRecipe(true, new ItemStack(Items.GHAST_TEAR), CREEPER_GLAND, CREEPER_GLAND, CREEPER_GLAND);
		addRecipe(true, new ItemStack(Items.SLIME_BALL, 6), SLIME_PEARL);
		addRecipe(true, new ItemStack(Items.ROTTEN_FLESH, 6), ZOMBIE_HEART);
		addRecipe(true, new ItemStack(Items.GOLD_NUGGET, 6), ZOMBIE_HEART, ZOMBIE_HEART);
		addRecipe(true, new ItemStack(Items.MAGMA_CREAM, 3), MOLTEN_CORE);
		addRecipe(true, new ItemStack(Items.BLAZE_ROD, 4), MOLTEN_CORE, MOLTEN_CORE);
		addRecipe(true, new ItemStack(Items.GUNPOWDER, 10), STORM_EYE);
		addRecipe(true, new ItemStack(Items.SNOWBALL, 5), FROZEN_CORE);
		addRecipe(true, new ItemStack(Items.PRISMARINE_SHARD, 5), GUARDIAN_SPIKE);
		addRecipe(true, new ItemStack(Items.PRISMARINE_CRYSTALS, 10), GUARDIAN_SPIKE, GUARDIAN_SPIKE);
		addRecipe(false, new ItemStack(Items.GUNPOWDER, 6), "w  ", "w  ", "w  ", 'w', ModItems.witchHat);
		addRecipe(false, new ItemStack(Items.REDSTONE, 6), " w ", " w ", " w ", 'w', ModItems.witchHat);
		addRecipe(false, new ItemStack(Items.GLOWSTONE_DUST, 6), "  w", "  w", "  w", 'w', ModItems.witchHat);
		addRecipe(false, new ItemStack(Items.SUGAR, 6), "www", "   ", "   ", 'w', ModItems.witchHat);
