...
public class XRItems {
	...
	public static void init() {
		handgun = new ItemHandgun();
		bullet = new ItemBullet();
		mercyCross = new ItemMercyCross();
		magazine = new ItemMagazine();
		holyHandGrenade = new ItemHolyHandGrenade();
		fortuneCoin = new ItemFortuneCoin();
		glowingWater = new ItemGlowingWater();
		gunPart = new ItemGunPart();
		glowingBread = new ItemGlowingBread();
		sojournerStaff = new ItemSojournerStaff();
		alkahestryTome = new ItemAlkahestryTome();
		midasTouchstone = new ItemMidasTouchstone();
		emperorChalice = new ItemEmperorChalice();
		salamanderEye = new ItemSalamanderEye();
		iceRod = new ItemIceRod();
		condensedPotion = new ItemCondensedPotion();
		magicbane = new ItemMagicbane();
		witherlessRose = new ItemWitherlessRose();
		distortionCloak = new ItemDistortionCloak();
		emptyVoidTear = new ItemEmptyVoidTear();
		voidTear = new ItemVoidTear();
		wraithEye = new ItemWraithEye();
		voidSatchel = new ItemVoidSatchel();
		destructionCatalyst = new ItemDestructionCatalyst();
		heroMedallion = new ItemHeroMedallion();
