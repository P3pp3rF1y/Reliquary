...
public class Colors {
	...
	public static final String PROTECTION_COLOR = "DDBBBB";
	public static final String POTENCE_COLOR = "662222";
	public static final String CELERITY_COLOR = "00FFDD";
	public static final String PANACEA_COLOR = "FF00FF";
	public static final String WATER_COLOR = "0055DD";
	public static final String SPLASH_COLOR = "0055DD";
