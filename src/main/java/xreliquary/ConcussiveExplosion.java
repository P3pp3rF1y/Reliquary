...
public class ConcussiveExplosion extends Explosion {
    ...
    public ConcussiveExplosion(World par1World, Entity par2Entity,
            EntityPlayer par3Entity, double par3, double par5, double par7,
            float par9) {
    ...
    public void doExplosionA() {
        ...
        Vec3 var30 = worldObj.getWorldVec3Pool().getVecFromPool(explosionX,
        ...
        for (int var11 = 0; var11 < var9.size(); ++var11) {
            ...
            if (var13 <= 1.0D) {
                ...
                double var33 = MathHelper.sqrt_double(var15 * var15 + var17
                        * var17 + var19 * var19);
