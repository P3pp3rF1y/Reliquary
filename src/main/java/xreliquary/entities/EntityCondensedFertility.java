...
public class EntityCondensedFertility extends EntityThrowable {
    ...
    public EntityCondensedFertility(World par1World, double par2, double par4,
            ...
            for (int yD = -2; yD <= 1; yD++) {
                for (int zD = -1; zD <= 1; zD++) {
                    if (this.getThrower() instanceof EntityPlayer) {
                        Item.itemsList[Item.dyePowder.itemID].onItemUse(
                                new ItemStack(Item.dyePowder, 1, 15),
                                (EntityPlayer) this.getThrower(), worldObj, x
                                        + xD, y + yD, z + zD, 1, 0F, 0F, 0F);
                    }
                }
            }
        }
