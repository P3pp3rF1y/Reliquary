...
public abstract class EntityShotBase extends Entity implements IProjectile {
	...
	/**
	 * @param d
	 *            haphazardly determines the upper bounds of the [always
	 *            positive] gaussian
	...
	/**
	 * @param mop
	 *            an optional parameter, some shots need to know what entity
	 ...
	 * 
	 * @param mop
	 *            the MOP data of the tile/misc object being struck
	 */
	 ...
	 * 
	 * @param sideHit
	 *            is sometimes used when you need particles to fly in a certain
	 *            direction.
	 */
	 ...
	 * 
	 * @param string
	 *            the name of the particle you want it to spawn
	 * @param i
	 *            the number of times you want the inner for loop to produce a
