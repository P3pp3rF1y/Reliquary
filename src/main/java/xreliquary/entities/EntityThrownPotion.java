...
public abstract class EntityThrownPotion extends EntityThrowable {
    ...
    //called by the splashEffect so that it can skip the bounding box and entity iteration, just keeps things moving.
    ...
    //these are just the getters for the particle coloration. They're all the same particle style, so it's really just a matter of coloration.
