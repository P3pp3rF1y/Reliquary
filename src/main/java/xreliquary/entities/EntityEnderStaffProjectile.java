...
public class EntityEnderStaffProjectile extends EntityEnderPearl {
    ...
    protected float getGravityVelocity() {
        ...
        //stolen from the "special" snowball, altered to allow two gravity options (one emulates a normal ender pearl).
...
//            var18 = 0.8F;
    ...
    {
        //I broke this because I pass null when it touches water.. only cos I ain't using it.
