...
public class EntityBusterShot extends Entity implements IProjectile {
    private int xTile = -1;
    private int yTile = -1;
    private int zTile = -1;
    ...
    public EntityBusterShot(World par1World, double par2, double par4,
            double par6) {
        super(par1World);
        this.setSize(0.5F, 0.5F);
    ...
    private void onImpact(Entity mop) {
        ...
        ConcussiveExplosion.customBusterExplosion(this, shootingEntity, posX, posY, posZ,
                4.0F, false, true);
        this.setDead();
    }
