...
public class EntityCondensedSplashWither extends EntityThrowable {
    ...
    public EntityCondensedSplashWither(World par1World, double par2,
    ...
    protected void onImpact(MovingObjectPosition mop) {
        ...
        while (i.hasNext()) {
            ...
            e.addPotionEffect(new PotionEffect(Potion.wither.id, 1200, 0));
        }
