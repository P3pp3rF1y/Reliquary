...
public class BlazeShotEntity extends ShotEntityBase {
	...
	protected void onImpact(RayTraceResult result) {
		if (result.getType() == RayTraceResult.Type.ENTITY) {
			...
			if (entityHit == getShooter() || !(entityHit instanceof LivingEntity)) {
				return;
			}
			...
			if (((PlayerEntity) getShooter()).canPlayerEdit(fireSpawnPos, blockResult.getFace(), new ItemStack(Items.FLINT_AND_STEEL)) && world.isAirBlock(fireSpawnPos)) {
