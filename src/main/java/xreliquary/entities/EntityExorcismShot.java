...
public class EntityExorcismShot extends EntityShotBase {
    ...
    void onImpact(Entity mop) {
        ...
        //we could factor out the whole method. "mobSpellAmbient" is a weird particle.
    ...
    int getDamageOfShot(Entity mop) {
        //there is a relatively small chance this will fail to kill an undead creature.
        //undead take 10-12 damage, in addition to the 9-14 damage they would normally do.
