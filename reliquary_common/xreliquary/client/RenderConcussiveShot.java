...
public class RenderConcussiveShot extends Render {
    ...
    public void doRenderConcussiveShot(EntityConcussiveShot entityShot,
            double par2, double par4, double par6, float par8, float par9) {
        GL11.glPushMatrix();
        GL11.glTranslatef((float) par2, (float) par4, (float) par6);
        GL11.glEnable(GL12.GL_RESCALE_NORMAL);
        GL11.glScalef(0.1F, 0.1F, 0.1F);
        this.loadTexture(Reference.CONCUSSIVE);
    ...
    public void doRender(Entity par1Entity, double par2, double par4,
        ...
        this.doRenderConcussiveShot((EntityConcussiveShot) par1Entity, par2,
                par4, par6, par8, par9);
    }
}