...
public class EntityCondensedSplashAphrodite extends EntityThrowable {
    ...
    public EntityCondensedSplashAphrodite(World par1World, double par2,
    ...
    protected void onImpact(MovingObjectPosition mop) {
        ...
        while (i.hasNext()) {
            ...
            for (int var3 = 0; var3 < 7; ++var3) {
                ...
                worldObj.spawnParticle("heart", e.posX + rand.nextFloat()
                        * e.width * 2.0F - e.width,
                        e.posY + 0.5D + rand.nextFloat() * e.height, e.posZ
                                + rand.nextFloat() * e.width * 2.0F - e.width,
                        var4, var6, var8);
            }
    ...
    private void spawnParticles() {
        ...
        for (int var15 = 0; var15 < 8; ++var15) {
            worldObj.spawnParticle(var14, var8, var10, var12,
        ...
        for (int var20 = 0; var20 < 100; ++var20) {
            ...
            if (worldObj.isRemote) {
                EntityFX var31 = Minecraft.getMinecraft().renderGlobal
                        .doSpawnParticle(var19, var8 + var25 * 0.1D,
                                var10 + 0.3D, var12 + var29 * 0.1D, var25,
                                var27, var29);
                if (var31 != null) {
        ...
        worldObj.playSoundEffect(posX + 0.5D, posY + 0.5D, posZ + 0.5D,
                "random.glass", 1.0F, worldObj.rand.nextFloat() * 0.1F + 0.9F);
    }
}
