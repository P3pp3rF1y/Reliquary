...
public class EntitySpecialSnowball extends EntitySnowball {
    ...
    public EntitySpecialSnowball(World par1World, double par2, double par4,
            double par6) {
    ...
    public void onUpdate() {
        ...
        if (ticksInAir % 4 == worldObj.rand.nextInt(5)) {
            worldObj.spawnParticle("reddust", posX, posY, posZ, 5.0D, 5.0D,
                    1.0D);
        }
        ...
        posY += motionY;
        posZ += motionZ;
        float var17 = MathHelper.sqrt_double(motionX * motionX + motionZ
                * motionZ);
