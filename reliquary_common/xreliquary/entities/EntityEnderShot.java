...
public class EntityEnderShot extends Entity implements IProjectile {
    private int xTile = -1;
    private int yTile = -1;
    private int zTile = -1;
    ...
    public EntityEnderShot(World par1World, double par2, double par4,
            double par6) {
        super(par1World);
        this.setSize(0.5F, 0.5F);
    ...
    private void doPortalExplosion() {
        for (int particles = 0; particles < 3; particles++) {
            worldObj.spawnParticle("portal", posX, posY - 1, posZ,
                    gaussian(motionX), gaussian(motionY), gaussian(motionZ));
    ...
    private void spawnHitParticles(String string, int i) {
        for (int particles = 0; particles < i; particles++) {
            worldObj.spawnParticle(string, posX, posY
                    - (string == "portal" ? 1 : 0), posZ, gaussian(motionX),
                    gaussian(motionY), gaussian(motionZ));
        }
    }
