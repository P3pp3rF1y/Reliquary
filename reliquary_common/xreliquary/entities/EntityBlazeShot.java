...
public class EntityBlazeShot extends Entity implements IProjectile {
    ...
    public EntityBlazeShot(World par1World, double par2, double par4,
            double par6) {
        super(par1World);
        this.setSize(0.5F, 0.5F);
    ...
    private void doFlightParticles() {
        if (ticksInAir % 3 == 0 && ticksInAir < 9) {
            worldObj.spawnParticle("flame", posX, posY, posZ,
                    lowGauss(motionX), lowGauss(motionY), lowGauss(motionZ));
        }
    }
    ...
    private void doBurstEffect(int sideHit) {
        for (int particles = 0; particles < 40; particles++) {
            ...
            case 0:
                worldObj.spawnParticle("flame", posX, posY, posZ,
                        smallGauss(0.1D) + motionX / 4, -posGauss(0.2D),
            ...
            case 2:
                worldObj.spawnParticle("flame", posX, posY, posZ,
                        smallGauss(0.1D) + motionX / 4, smallGauss(0.1D)
                                + motionY / 4, -posGauss(0.2D));
                break;
            case 3:
                worldObj.spawnParticle("flame", posX, posY, posZ,
                        smallGauss(0.1D) + motionX / 4, smallGauss(0.1D)
            ...
            case 4:
                worldObj.spawnParticle("flame", posX, posY, posZ,
                        -posGauss(0.2D), smallGauss(0.1D) + motionY / 4,
