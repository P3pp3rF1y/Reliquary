...
public class XRAlkahestry {
	...
	private static void addAlkahestry() {
		...
		GameRegistry.addRecipe(new ItemStack(Item.netherStar, 2), new Object[] { "tds", "www", "hhh", 'd', Item.diamond, 'w', new ItemStack(Item.skull, 1, 1), 't', XRItems.alkahestryTome, 's', Item.netherStar, 'h', XRItems.glowingWater });
	}
	...
	public static void addAlkahestry(Object baseItem, int meta, int yield, char reagentChar, int cost) {
		...
		GameRegistry.addShapelessRecipe(new ItemStack(original.getItem(), yield, meta), recipeItems);
	}
	...
	public static void addReverseRecipe(Object baseItem, int meta) {
		...
		recipeItems[1] = original;
		GameRegistry.addShapelessRecipe(new ItemStack(XRItems.alkahest, 1), recipeItems);
	}
