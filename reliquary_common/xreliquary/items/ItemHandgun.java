...
public class ItemHandgun extends ItemXR {
    ...
    private void fireBullet(ItemStack ist, World worldObj, EntityPlayer player) {
        if (!worldObj.isRemote) {
            ...
            case 1:
                ...
                break;
            case 2:
                EntityExorcismShot exs = new EntityExorcismShot(worldObj,
                        player);
            ...
            case 4:
                ...
                break;
            case 5:
                EntityConcussiveShot cs = new EntityConcussiveShot(worldObj,
                        player);
    ...
    private int getClipTypeAndSubtractOne(EntityPlayer player) {
        ...
        for (int slot = 0; slot < player.inventory.mainInventory.length; slot++) {
            ...
            if (player.inventory.mainInventory[slot].getItem() == XRItems.magazine
                    && player.inventory.mainInventory[slot].getItemDamage() != 0) {
                bulletFound = player.inventory.mainInventory[slot]
                        .getItemDamage();
