...
public class TEAltar extends TileEntity {
    ...
    public void updateEntity() {
        ...
        if (cycleTime > 0) {
            ...
            BlockAltar.updateAltarBlockState(isActive(), worldObj, xCoord,
                    yCoord, zCoord);
        }
    }
    ...
    public void startCycle() {
        ...
        isActive = true;
        redstoneCount = 0;
        BlockAltar.updateAltarBlockState(isActive(), worldObj, xCoord, yCoord,
                zCoord);
    }
    ...
    public void addRedstone() {
        System.out.println("Redstone count was " + redstoneCount
                + " and is now " + (redstoneCount + 1)
                + " - machine currently "
